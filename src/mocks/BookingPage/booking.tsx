import microphone from "../../../public/BookingForm/microphone.png";

export const MICROPHONE_IMG = microphone;
export const FORM_TITLE = "Запись";
export const REVIEW_PLACEHOLDER = "Отзыв";
...
export const DATA_PLACEHOLDER = "Дата";

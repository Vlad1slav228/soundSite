...
export const REVIEWS_DATA = [
  {
    ...
    reviewText:
      "Студия звукозаписи Sound прfdshkjfkjdsahfjlkhdsafjkhadskjfhsakdjhfkjsahdfkjhaskdjhfjksadhfkjhsdaklfjhsakdjhflkjsadhkfjhadskjfhkjdsahfjhsadlkjfhksadfоизвела на меня неизгладимое впечатление своей атмосферой и профессионализмом команды. Инженеры обладают глубокими знаниями в области звука и могут предложить множество решений для достижения желаемого результата. Я был приятно удивлен тем, насколько внимательно они относятся к каждой мелочи, будь то настройка микрофонов или обработка аудиофайлов.",
  },
  {
